    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center border rounded p-2 shadow">
            <div class="col-12 col-md-6">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate voluptas placeat tempora fugiat itaque reiciendis, animi necessitatibus inventore, quod sit laborum sed nostrum ipsum voluptatem repellat temporibus, dolorum voluptatibus maiores?</p>
            ...
            <div class="co-12 col-md-6">
               ...
               <div class="mb-3">
                ...
                <select name="role" id="role" class="form-control"><option value="">Scegli qui</option>
